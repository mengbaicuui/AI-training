...
export const llmHistoryData = [
    ...
    },
    {
        ...
        details: {
            ...
            questions: [
                {
                    question: '如果用一个公式来表示现在的LLM的智能，你会怎么表示？',
                    hint: '所有的技术铺垫',
                    answer: 'LLM智能 = 庞大的参数量（残差链接提升网络深度） + 可承担的训练/推理效率（transformer的并行训练、MoE的部分激活）+ 合理的模型架构（transformer的注意力机制） + 输入输出的对齐（SFT和RL）+ 推理时增强（Test-Time Scaling）'
                },
            ]
        }
    }
